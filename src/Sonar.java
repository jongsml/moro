...
{
	// JB: The fact that this code has a lot of comments with question marks in
	// it (see below)
	// does not give a lot of confidence. I have chosen to let the comments in,
	// as they could be
	...
	private double read(boolean first)
	{
		...
		for (int i = 0; i < environment.obstacles.size(); i++)
		{
			...
			Obstacle obstacle = environment.obstacles.get(i);
